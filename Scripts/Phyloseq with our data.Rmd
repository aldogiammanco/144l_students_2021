...
```{r message = F}
count.tab <- read_rds("~/Desktop/github/144l_students_2021/Input_Data/week9/seqtab-nochimtaxa.rds") #table of counts for each sequence in each sample, update the file path for the .rds file you generated with dada2
tax.tab <- read_rds("~/Desktop/github/144l_students_2021/Input_Data/week9/taxa.rds") #table that matches ASV to sequence, update file path to your own file
...
metadata_OG <- read_excel("~/Desktop/github/144l_students_2021/Input_Data/week9/144L_2021_metadata.xlsx", sheet = "Metadata")
glimpse(metadata_OG)
metadata <- metadata_OG %>%
  select(-Datetime)
glimpse(metadata)
#you can get this file from your own week6 data
metadata_doc <- read_rds("~/Desktop/github/144l_students_2021/Output_Data/week6/144L_Exp_Processed_BactAbund.rds")
glimpse(metadata_doc)
metadata_mock <- read_csv("~/Desktop/github/144l_students_2021/Input_Data/week9/144L_2018_metadata.csv")
...
nmds.plot <- plot_ordination(sub_ps, nmds,  title = "NMDS") +
   geom_point(aes(fill = Timepoint, shape = factor(Treatment, levels = levels)), alpha = 0.6, stroke = 2, size = 4) +
...
nmds.plot + 
  ...
  guides(fill = guide_colorbar(title = "Timepoint"), shape = guide_legend(title = "Treatment"))
```
...
```{r}
saveRDS(sweet.tab, "~/Desktop/github/144l_students_2021/Output_Data/week9/Custom_ASV_Table.rds")
saveRDS(sub_ps, "~/Desktop/github/144l_students_2021/Output_Data/week9/phyloseq_obj.rds")
saveRDS(ps_min, "~/Desktop/github/144l_students_2021/Output_Data/week9/subsampled_phyloseq_obj.rds")
saveRDS(alphadiv, "~/Desktop/github/144l_students_2021/Output_Data/week9/alphadiv.rds")
...
ggplot(data= gen.top, aes(x= Sample, y= Abundance, fill=Family)) +
  ...
  theme_classic()+
  theme(axis.text.x=element_text(margin = margin(t = 5, r = 0, b = 3, l = 0),angle =30, size=7, vjust = 1.2, hjust = 1),
